...
import co.xiaoxiang.modules.shop.mapper.YxStoreCouponIssueMapper;
import co.xiaoxiang.modules.shop.mapper.YxStoreCouponIssueUserMapper;
import co.xiaoxiang.modules.shop.service.YxStoreCouponIssueService;
import co.xiaoxiang.modules.shop.service.YxStoreCouponIssueUserService;
import co.xiaoxiang.modules.shop.service.YxStoreCouponUserService;
import co.xiaoxiang.modules.shop.web.param.YxStoreCouponIssueQueryParam;
...
public class YxStoreCouponIssueServiceImpl extends BaseServiceImpl<YxStoreCouponIssueMapper, YxStoreCouponIssue> implements YxStoreCouponIssueService {
    ...
    @Override
    public List<YxStoreCouponIssueQueryVo> getRegisterCouponIssue() {
        List<YxStoreCouponIssueQueryVo> couponList = yxStoreCouponIssueMapper.selectRegisterCouponList();
        return couponList;
    }
