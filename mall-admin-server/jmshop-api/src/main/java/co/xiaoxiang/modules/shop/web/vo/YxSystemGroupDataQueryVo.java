package co.xiaoxiang.modules.shop.web.vo;
 ...
 */
@Data
@ApiModel(value = "YxSystemGroupDataQueryVo对象", description = "组合数据详情表查询参数")
public class YxSystemGroupDataQueryVo implements Serializable {
