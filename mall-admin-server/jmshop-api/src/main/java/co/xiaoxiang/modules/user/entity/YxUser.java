package co.xiaoxiang.modules.user.entity;
...
public class YxUser extends BaseEntity {
    ...
    @ApiModelProperty(value = "用户申请会员等级")
    private Integer applyLevel;

    @ApiModelProperty(value = "用户申请会员等级申请材料")
    private String certInfo;

    @ApiModelProperty(value = "会员等级是否审核")
    private Integer isCheck;

    @ApiModelProperty(value = "会员等级是否审核通过")
