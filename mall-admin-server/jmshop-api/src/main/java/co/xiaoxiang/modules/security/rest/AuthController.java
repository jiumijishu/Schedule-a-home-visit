 ...
 */
package co.xiaoxiang.modules.security.rest;
...
import co.xiaoxiang.common.api.ApiCode;
...
import co.xiaoxiang.modules.security.config.SecurityProperties;
import co.xiaoxiang.modules.security.rest.param.LoginParam;
import co.xiaoxiang.modules.security.rest.param.RegParam;
import co.xiaoxiang.modules.security.rest.param.VerityParam;
import co.xiaoxiang.modules.security.security.TokenProvider;
import co.xiaoxiang.modules.security.security.vo.AuthUser;
import co.xiaoxiang.modules.security.security.vo.JwtUser;
import co.xiaoxiang.modules.security.service.OnlineUserService;
...
import co.xiaoxiang.modules.user.service.*;
...
import co.xiaoxiang.mp.config.WxMpConfiguration;
import co.xiaoxiang.utils.*;
    ...
    public ApiResult<Object> authLogin(@RequestParam(value = "code") String code,
        ...
        try {
            ...
            if (ObjectUtil.isNull(yxUser)) {
                ...
                if(StringUtils.isNotEmpty(nickname) && "微信用户".equals(nickname)){
                    nickname="小象农庄"+username.substring(username.length()-4);
