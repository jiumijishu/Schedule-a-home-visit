...
import co.xiaoxiang.modules.activity.mapper.YxStoreBargainMapper;
import co.xiaoxiang.modules.activity.mapper.YxStoreCombinationMapper;
import co.xiaoxiang.modules.activity.mapper.YxStoreSeckillMapper;
import co.xiaoxiang.modules.activity.service.YxStoreBargainService;
import co.xiaoxiang.modules.activity.service.YxStoreCombinationService;
...
import co.xiaoxiang.modules.shop.mapping.CartMap;
...
public class YxStoreCartServiceImpl extends BaseServiceImpl<YxStoreCartMapper, YxStoreCart> implements YxStoreCartService {
    ...
    public int addCart(int uid, int productId, int cartNum, String productAttrUnique, String type, int isNew, int combinationId, int seckillId, int bargainId, String packaging, int packNum, BigDecimal alterPrice) {
        ...
        YxStoreProduct product=productService.getProductInfo(productId);
        ...
        storeCart.setIsPre("02".equals(product.getProductType())?1:0);
