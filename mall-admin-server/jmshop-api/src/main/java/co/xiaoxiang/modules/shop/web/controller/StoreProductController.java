 ...
 */
package co.xiaoxiang.modules.shop.web.controller;
...
import co.xiaoxiang.enums.AppFromEnum;
import co.xiaoxiang.enums.ProductEnum;
import co.xiaoxiang.enums.RedisKeyEnum;
import co.xiaoxiang.modules.order.web.vo.WxQrCode;
import co.xiaoxiang.modules.shop.entity.YxStorePretype;
import co.xiaoxiang.modules.shop.entity.YxStoreProduct;
import co.xiaoxiang.modules.shop.entity.YxVideo;
...
import co.xiaoxiang.modules.shop.web.param.YxVideoQueryParam;
import co.xiaoxiang.modules.shop.web.vo.YxStoreProductQueryVo;
import co.xiaoxiang.modules.shop.web.vo.YxVideoQueryVo;
import co.xiaoxiang.modules.user.entity.YxSystemAttachment;
import co.xiaoxiang.modules.user.service.YxSystemAttachmentService;
import co.xiaoxiang.modules.user.service.YxUserService;
import co.xiaoxiang.modules.user.web.vo.YxSystemLevelProduct;
...
import co.xiaoxiang.utils.StringUtils;
...
public class StoreProductController extends BaseController {
    ...
    private final YxStorePreTypeService pretypeService;
     ...
     */
    @AnonymousAccess
    @GetMapping("/preProducts")
    @ApiOperation(value = "预售商品列表", notes = "预售商品列表")
    public ApiResult<List<YxStoreProductQueryVo>> preGoodsList(YxStoreProductQueryParam productQueryParam) {
        return ApiResult.ok(storeProductService.getPreGoodsList(productQueryParam));
    }
    ...
    @AnonymousAccess
    @GetMapping("/allPreTypes")
    @ApiOperation(value = "视频类型", notes = "视频类型")
    public ApiResult<List<YxStorePretype>> allPreTypes() {
        return ApiResult.ok(pretypeService.selectPretypeList());
    }
