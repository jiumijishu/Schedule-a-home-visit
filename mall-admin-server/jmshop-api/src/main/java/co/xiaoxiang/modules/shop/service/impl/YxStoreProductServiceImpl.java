...
import co.xiaoxiang.enums.CommonEnum;
import co.xiaoxiang.enums.ProductEnum;
import co.xiaoxiang.enums.RedisKeyEnum;
import co.xiaoxiang.enums.ShopCommonEnum;
import co.xiaoxiang.enums.SortEnum;
...
import co.xiaoxiang.modules.shop.mapper.YxStoreCategoryMapper;
import co.xiaoxiang.modules.shop.mapper.YxStoreProductAttrValueMapper;
import co.xiaoxiang.modules.shop.mapper.YxStoreProductMapper;
import co.xiaoxiang.modules.shop.mapping.YxStoreProductMap;
...
//        productDTO.setSystemStore(systemStoreService.getStoreInfo(latitude, longitude));
    ...
    public List<YxStoreProductQueryVo> getGoodsList(YxStoreProductQueryParam productQueryParam) {
        ...
        LambdaQueryWrapper<YxStoreProduct> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(YxStoreProduct::getIsDel, CommonEnum.DEL_STATUS_0.getValue()).eq(YxStoreProduct::getIsShow, CommonEnum.SHOW_STATUS_1.getValue());
        wrapper.eq(YxStoreProduct::getProductType,"01");
        //多字段模糊查询分类搜索
    ...
    @Override
    public List<YxStoreProductQueryVo> getPreGoodsList(YxStoreProductQueryParam productQueryParam) {

        LambdaQueryWrapper<YxStoreProduct> wrapper = new LambdaQueryWrapper<>();
        wrapper.eq(YxStoreProduct::getIsDel, CommonEnum.DEL_STATUS_0.getValue()).eq(YxStoreProduct::getIsShow, CommonEnum.SHOW_STATUS_1.getValue());
        wrapper.eq(YxStoreProduct::getProductType,"02");
        wrapper.eq(YxStoreProduct::getPreType,productQueryParam.getPretypeId());
        //多字段模糊查询分类搜索
        if (StrUtil.isNotBlank(productQueryParam.getSid()) &&
                !ShopConstants.PUSHMALL_ZERO.equals(productQueryParam.getSid())) {
            wrapper.eq(YxStoreProduct::getCateId, productQueryParam.getSid());
