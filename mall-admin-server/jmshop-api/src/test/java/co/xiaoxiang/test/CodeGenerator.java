...
public class CodeGenerator {
    ...
    private static final String PARENT_PACKAGE = "co.xiaoxiang";
    ...
    private static final String PROJECT_PACKAGE_PATH = "co/xiaoxiang";

    private static final String PARENT_PACKAGE2 = "co.xiaoxiang.modules";
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir(projectPath + "/jmshop-api/src/main/java");
        gc.setAuthor(AUTHOR);
        ...
        pc.setParent("co.xiaoxiang.modules");
        ...
        focList.add(new FileOutConfig("/templates/mapper.xml.vm") {
            ...
            public String outputFile(TableInfo tableInfo) {
                // 自定义输入文件名称
                return projectPath + "/jmshop-api/src/main/resources/mapper/" + pc.getModuleName()
        ...
        focList.add(new FileOutConfig("/templates/queryParam.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/jmshop-api/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modules/" + pc.getModuleName() + "/web/param/" + tableInfo.getEntityName() + "QueryParam" + StringPool.DOT_JAVA;
            }
        });
        ...
        focList.add(new FileOutConfig("/templates/queryVo.java.vm") {
            @Override
            public String outputFile(TableInfo tableInfo) {
                return projectPath + "/jmshop-api/src/main/java/"+ PROJECT_PACKAGE_PATH +"/modules/" + pc.getModuleName() + "/web/vo/" + tableInfo.getEntityName() + "QueryVo" + StringPool.DOT_JAVA;
            }
        });
