...
import co.xiaoxiang.mp.handler.RedisHandler;
...
public class YxPayService {
     ...
     */
    public WxPayMpOrderResult wxPaySamll(String orderId, String openId, String body, Integer totalFee, String attach) throws WxPayException {
