package co.xiaoxiang.express;

import cn.hutool.http.HttpUtil;
import co.xiaoxiang.express.config.ExpressProperties;
...
//    private String ReqURL = "http://api.kdniao.com/Ebusiness/EbusinessOrderHandle.aspx";
     ...
     * @return
     */
    public ExpressInfo getExpressInfo(String OrderCode, String ShipperCode, String LogisticCode,String customerName) {
        try {
            String result = getOrderTracesByJson(OrderCode, ShipperCode, LogisticCode,customerName);
     ...
     * @throws Exception
     */
    private String getOrderTracesByJson(String OrderCode, String ShipperCode, String LogisticCode,String customerName) throws Exception {
        if (!properties.isEnable()) {
            return null;
        }
        String requestData = "{'OrderCode':'" + OrderCode + "','ShipperCode':'" + ShipperCode + "','LogisticCode':'" + LogisticCode + "'}";
        if("SF".equalsIgnoreCase(ShipperCode)){
