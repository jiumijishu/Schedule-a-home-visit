...
import co.xiaoxiang.domain.Picture;
import co.xiaoxiang.service.dto.PictureQueryCriteria;
import co.xiaoxiang.utils.*;
import com.alibaba.fastjson.JSON;
import lombok.extern.slf4j.Slf4j;
import co.xiaoxiang.repository.PictureRepository;
import co.xiaoxiang.service.PictureService;
...
public class PictureServiceImpl implements PictureService {
    ...
    public Picture upload(MultipartFile multipartFile, String username) {
        ...
        // 上传文件
        String result= HttpRequest.post(JmshopConstant.Url.SM_MS_URL + "/v2/upload")
    ...
    public void synchronize() {
        //链式构建请求
        String result = HttpRequest.get(JmshopConstant.Url.SM_MS_URL + "/v2/upload_history")
                //头信息，多个头信息多次调用此方法即可
                .header("Authorization", token)
                .timeout(20000)
                .execute().body();
