...
public class YxStoreProduct implements Serializable {
    ...
    @Column(name = "haibao_image",nullable = true)
    ...
    //@NotBlank(message = "请填写条形码")
    private String barCode;

    @Column(name = "cate_id",nullable = true,insertable = false,updatable = false)
...
//    @NotNull(message = "库存必填")
    ...
    @Column(name = "qrcode_image",nullable = true,insertable = true)
...
//    @Min(value = 0)
    ...
    @Column(name = "pre_type",nullable = true)
    private String preType;

    @Column(name = "period_num",nullable = true)
