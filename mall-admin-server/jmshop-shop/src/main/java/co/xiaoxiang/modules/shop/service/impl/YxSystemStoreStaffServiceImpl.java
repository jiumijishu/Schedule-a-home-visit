...
import co.xiaoxiang.modules.shop.service.YxSystemStoreService;
...
import co.xiaoxiang.modules.shop.repository.YxSystemStoreStaffRepository;
...
import co.xiaoxiang.modules.shop.service.mapper.YxSystemStoreStaffMapper;
...
public class YxSystemStoreStaffServiceImpl implements YxSystemStoreStaffService {
    ...
    @Override
    public List<YxSystemStoreStaffDto> findByUid(Integer uid, Integer spreadUid) {
        return yxSystemStoreStaffMapper.toDto(yxSystemStoreStaffRepository.findByUid(uid, spreadUid));
    }
     ...
     */
    @Override
    public YxSystemStoreStaffDto findByUids(Integer uid, Integer spreadUid) {
        return yxSystemStoreStaffMapper.toDto(yxSystemStoreStaffRepository.findByUids(uid, spreadUid));
    }
}
