...
import co.xiaoxiang.enums.OrderInfoEnum;
import co.xiaoxiang.exception.BadRequestException;
import co.xiaoxiang.exception.EntityExistException;
import co.xiaoxiang.modules.activity.domain.YxStorePink;
import co.xiaoxiang.modules.activity.repository.YxStorePinkRepository;
import co.xiaoxiang.modules.shop.domain.*;
import co.xiaoxiang.modules.shop.repository.*;
import co.xiaoxiang.modules.shop.service.*;
import co.xiaoxiang.modules.shop.service.dto.*;
import co.xiaoxiang.modules.shop.service.mapper.YxStoreOrderMapper;
...
//        map.put("chartT", yxStoreOrderRepository.chartListT(nowMonth));
    ...
    @Override
    public String orderType(Integer id, Integer pinkId, Integer combinationId, Integer seckillId,
                            Integer bargainId, Integer shippingType,Integer isPre) {
        String str = "[普通订单]";
    ...
    public List<YxStoreOrderDTO> manageList(List<YxStoreOrder> content) {
        ...
        for (YxStoreOrder yxStoreOrder : content) {
            ...
            yxStoreOrderDTO.setPinkName(orderType(yxStoreOrder.getId()
                    ...
                    yxStoreOrder.getShippingType(),yxStoreOrder.getIsPre()));
