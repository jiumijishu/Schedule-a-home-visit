...
import co.xiaoxiang.modules.shop.service.dto.OrderCountDto;
import co.xiaoxiang.modules.shop.service.dto.OrderTimeDataDTO;
import co.xiaoxiang.modules.shop.service.dto.YxStoreOrderDTO;
import co.xiaoxiang.modules.shop.service.dto.YxStoreOrderQueryCriteria;
...
public interface YxStoreOrderService {
    ...
    String orderType(Integer id, Integer pinkId, Integer combinationId, Integer seckillId,
    ...
    */
    ...
    List<YxStoreOrderDTO> findByIds(List<String> idList);
