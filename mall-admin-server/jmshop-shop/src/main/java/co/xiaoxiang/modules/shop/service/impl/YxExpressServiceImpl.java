...
import co.xiaoxiang.modules.shop.repository.YxExpressRepository;
import co.xiaoxiang.modules.shop.service.YxExpressService;
import co.xiaoxiang.modules.shop.service.dto.YxExpressDTO;
import co.xiaoxiang.modules.shop.service.dto.YxExpressQueryCriteria;
import co.xiaoxiang.modules.shop.service.mapper.YxExpressMapper;
...
public class YxExpressServiceImpl implements YxExpressService {
    ...
    public YxExpressDTO findById(Integer id) {
        ...
        if(yxExpress.isPresent()){
            return yxExpressMapper.toDto(yxExpress.get());
        }
        return new YxExpressDTO();
    }
