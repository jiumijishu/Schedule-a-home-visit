...
public class SystemStoreStaffController {
    ...
    public ResponseEntity<Object> create(@Validated @RequestBody YxSystemStoreStaff resources){
        List<YxSystemStoreStaffDto> spreadList = yxSystemStoreStaffService.findByUid(resources.getUid(), resources.getSpreadUid());
    ...
    public ResponseEntity<Object> find(@PathVariable String uid, @PathVariable String spreadUid){
        return new ResponseEntity<>(yxSystemStoreStaffService.findByUid(Integer.valueOf(uid), Integer.valueOf(spreadUid)), HttpStatus.OK);
    }
