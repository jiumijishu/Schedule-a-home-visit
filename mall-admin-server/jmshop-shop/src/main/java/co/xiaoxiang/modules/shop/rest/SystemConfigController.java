...
import co.xiaoxiang.modules.shop.service.dto.YxSystemConfigQueryCriteria;
import co.xiaoxiang.mp.config.WxMpConfiguration;
import co.xiaoxiang.mp.config.WxPayConfiguration;
    ...
    public ResponseEntity create(@RequestBody String jsonStr){
        ...
        jsonObject.forEach(
                (key,value)->{
                    ...
                    if(RedisKeyEnum.CCB_MERCHANTID.getValue().equals(key) || RedisKeyEnum.CCB_POSID.getValue().equals(key)|| RedisKeyEnum.CCB_BRANCHID.getValue().equals(key)){
                        //WxPayConfiguration.removeWxPayService();
                    }
