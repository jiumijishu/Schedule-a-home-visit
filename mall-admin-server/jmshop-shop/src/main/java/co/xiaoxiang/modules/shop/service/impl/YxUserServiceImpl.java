...
public class YxUserServiceImpl implements YxUserService {
    ...
    public void onIsPass(Integer uid, Integer isPass, Integer applyLevel) {
        yxUserRepository.updateOnIsPass(isPass,applyLevel,uid);
    }
    ...
    @Override
    public List<YxUserDTO> findByLevel(Integer id) {
        return yxUserMapper.toDto(yxUserRepository.findByLevel(id));
    }

    @Override
    public void removeUserLevel(Integer uid) {
        yxUserRepository.updateUserLevel(uid);
    }
