...
import co.xiaoxiang.modules.shop.domain.YxUserLevel;
import co.xiaoxiang.modules.shop.repository.YxSystemUserLevelRepository;
import co.xiaoxiang.modules.shop.repository.YxUserLevelRepository;
import co.xiaoxiang.modules.shop.repository.YxUserRepository;
import co.xiaoxiang.modules.shop.service.YxUserBillService;
import co.xiaoxiang.modules.shop.service.YxUserLevelService;
import co.xiaoxiang.modules.shop.service.YxWechatUserService;
import co.xiaoxiang.modules.shop.service.dto.YxSystemUserLevelDTO;
import co.xiaoxiang.modules.shop.service.dto.YxUserLvelCriteria;
import co.xiaoxiang.modules.shop.service.dto.YxWechatUserDTO;
import co.xiaoxiang.modules.shop.service.mapper.YxSystemUserLevelMapper;
import co.xiaoxiang.modules.shop.service.mapper.YxUserMapper;
import co.xiaoxiang.utils.OrderUtil;
import co.xiaoxiang.utils.QueryHelp;
import co.xiaoxiang.utils.TencentMsgUtil;
...
public class YxUserLevelServiceImpl implements YxUserLevelService {
    ...
    public void autoNoticeExpireUser() {
        ...
        userLevelList.stream().forEach(userLevel->{
            ...
            if(userLevel.getValidTime()> currentTIme){
                int hour= (userLevel.getValidTime()-currentTIme);
                if(hour>0 && hour<=86400){
    ...
    @Override
    public void removeUserLevel(Integer uid) {
        YxUserLevel yxUserLevel = yxUserLevelRepository.selectOne(uid);
        if(ObjectUtil.isNotNull(yxUserLevel)){
            yxUserLevelRepository.deleteById(yxUserLevel.getId());
        }
    }
