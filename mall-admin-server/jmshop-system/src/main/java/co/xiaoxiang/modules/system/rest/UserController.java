package co.xiaoxiang.modules.system.rest;

import cn.hutool.core.util.StrUtil;
import cn.hutool.crypto.asymmetric.KeyType;
import cn.hutool.crypto.asymmetric.RSA;
import co.xiaoxiang.aop.log.Log;
import co.xiaoxiang.config.DataScope;
import co.xiaoxiang.config.RsaProperties;
import co.xiaoxiang.domain.VerificationCode;
import co.xiaoxiang.exception.BadRequestException;
import co.xiaoxiang.modules.system.domain.User;
import co.xiaoxiang.modules.system.domain.vo.UserPassVo;
import co.xiaoxiang.modules.system.service.DeptService;
import co.xiaoxiang.modules.system.service.RoleService;
import co.xiaoxiang.modules.system.service.UserService;
import co.xiaoxiang.modules.system.service.dto.RoleSmallDTO;
import co.xiaoxiang.modules.system.service.dto.UserDTO;
import co.xiaoxiang.modules.system.service.dto.UserQueryCriteria;
import co.xiaoxiang.service.VerificationCodeService;
import co.xiaoxiang.utils.PageUtil;
import co.xiaoxiang.utils.RsaUtils;
import co.xiaoxiang.utils.SecurityUtils;
import co.xiaoxiang.utils.JmshopConstant;
...
public class UserController {
    ...
    public ResponseEntity<Object> updateEmail(@PathVariable String code,@RequestBody User user) throws Exception {
        ...
        VerificationCode verificationCode = new VerificationCode(code, JmshopConstant.RESET_MAIL,"email",user.getEmail());
